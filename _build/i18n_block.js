...
const I18N = {
  ...
  "zh-tw": {
    ...
    cats: {
      "都市で楽しむ芸術祭":"城市型藝術祭","里山・島を巡る芸術祭":"鄉野・島嶼藝術祭",
    ...
    detailTitle: "藝術祭詳情", detailTitleEn: "Detail",
    selectedTitle: "已選擇的藝術祭", selectedTitleEn: "Selected",
    detailGuideTitle: "所選藝術祭的詳細資訊會顯示在這裡。",
    detailGuideCopy: "請從左側列表或右側地圖選擇感興趣的藝術祭。圖片、展期、旅行參考與亮點都會顯示在中央欄位。",
    arrowList: "← 從列表選擇", arrowMap: "從地圖選擇 →",
    recommendTitleMonth: (m) => `${m}月可以去的推薦藝術祭`,
    recommendTitleYear: "今年值得去的藝術祭",
    recommendLeadMonth: (m) => `從展期涵蓋${m}月的藝術祭中，挑選現在就能前往的3個。`,
    recommendLeadYear: (y) => `從正在舉辦、${y}年即將開始，以及全年開放的藝術祭中挑選3個。`,
    recommendEmpty: "目前沒有符合此條件的推薦藝術祭。",
    recommendEmptyMobile: "沒有符合此條件的推薦藝術祭。",
    discoverFoot: (y) => `可以組合「正在舉辦」「${y}年即將舉辦」「按月份」「旅行主題」「旅行方式」來查找。`,
    noResults: "沒有符合條件的藝術祭", noResultsEn: "No results",
    countUnit: (n,t) => `${n} / ${t}`
  }
};
...
const CASE_CONTENT_ZH_TW = {
  "札幌国際芸術祭（SIAF）": {
    ...
    "desc": "以“創意城市札幌”為背景，將豐富的自然環境、城市基礎設施、大學以及IT與媒體藝術社群連接起來的國際藝術祭。"
  },
  "AOMORI GOKAN": {
    "name": "AOMORI GOKAN 青森五館",
    "tagline": "穿行於青森的五座美術館與藝術中心之間。",
    "desc": "由青森縣5座美術館與藝術中心共同開展的聯動計畫，透過跨館旅行推廣當地藝術生態，並促進文化、經濟與教育的發展。",
    "dateText": "5個場館全年均可參觀。"
  },
  "三陸国際芸術祭": {
    "name": "三陸國際藝術祭",
    "tagline": "旅行三陸，感受扎根於土地的傳統表演藝術。",
    "desc": "讓三陸傳統藝能與日本及海外藝術家展開對話的藝術祭。計畫致力於震後文化復興、培養下一代傳承者，並向更廣泛的觀眾介紹當地多元文化遺產。"
  },
  "リボーンアートフェス": {
    "name": "重生藝術祭（Reborn-Art Festival）",
    "tagline": "在石卷同時體驗藝術、音樂與美食。",
    "desc": "在東日本大地震受災地石卷舉辦的綜合型藝術祭，以“Reborn-Art—生活方式”為理念，將當代藝術、地方飲食與現場音樂結合起來。"
  },
  "かみこあにプロジェクト": {
    "name": "上小阿仁計畫",
    "tagline": "在秋田的小村莊里發現藝術與日常生活。",
    "desc": "在高齡化程度較高的秋田縣上小阿仁村持續舉辦的計畫，以當代藝術、音樂和傳統藝能為核心，由當地居民主導的執行委員會長期營運。",
  ...
  "取手アートプロジェクト": {
    ...
    "desc": "自1999年起由居民、取手市與東京藝術大學共同營運。2010年後從節慶型轉向長期計畫，包括以住宅區和農業為舞台的持續性實踐。"
  },
  "KEAT 小砂環境芸術祭": {
    "name": "KEAT 小砂環境藝術祭",
    "tagline": "在栃木的里山之間行走於自然與藝術之間。",
    "desc": "在栃木縣那珂川町小砂舉辦的藝術祭。透過藝術重新發現地方價值，並探索與自然環境溫和共生的新文化。"
  },
  "中之条ビエンナーレ": {
    "name": "中之條雙年展",
    "tagline": "以藝術為線索，旅行群馬的溫泉鄉與里山。",
    "desc": "每兩年在群馬縣中之條町舉辦的國際當代藝術祭。藝術家駐村於山村，根據當地裡山文化進行創作，並在雙年展期間展出。"
  },
  "さいたま国際芸術祭": {
    "name": "埼玉國際藝術祭",
    "tagline": "在埼玉市各處探索當代藝術。",
    "desc": "每三年在埼玉市舉辦的藝術祭，以市民參與為核心，在多種場所創造居民、藝術家與社區相遇合作的機會。"
  },
  "千葉国際芸術祭": {
    "name": "千葉國際藝術祭",
    "tagline": "透過藝術重新觀看千葉的日常城市風景。",
    "desc": "2025年在千葉市啓動的三年一屆藝術祭，不只追求短期觀光，而是希望激發市民與訪客的創造力，讓日常生活在中長期中變得更豐富。"
  },
  "東京ビエンナーレ": {
    "name": "東京雙年展",
  ...
  "大地の芸術祭": {
    ...
    "desc": "世界規模最大的國際藝術祭之一，也是日本地域型藝術祭的重要先驅。以藝術為線索旅行裡山的模式受到國際關注，主展之間也持續舉辦季節性計畫。"
  },
  "ガラスの街とやま": {
    "name": "玻璃之城·富山（Glass Art City, Toyama）",
  ...
  "Go FOR KOGEI": {
    ...
    "desc": "2020年啓動的計畫，從新的角度重新理解擁有悠久製造傳統的北陸工藝。展覽分布於歷史街區、寺院與神社，並透過論壇等討論工藝在當代生活中的意義。"
  },
  "Zen AIR（禅×AIR）": {
    "name": "禪 AIR（ZEN AIR）",
    "tagline": "體驗由禪文化塑造的藝術家駐村。",
    "desc": "在福井縣永平寺地區開展的主題型藝術家駐村計畫。藝術家透過禪修體驗與居民交流進行研究和創作，並以作品與研究成果向公眾分享。"
  },
  "FUJI TEXTILE WEEK": {
    "name": "富士紡織周（FUJI TEXTILE WEEK）",
    "tagline": "漫步富士吉田這座織物與設計之城。",
    "desc": "2021年在擁有千年以上紡織歷史的山梨縣富士吉田啓動的紡織與藝術祭，將當代藝術實踐、傳統產業與地方振興連接起來。",
    "dateText": "下一屆日期尚未公佈（2025屆已結束）。"
  },
  "北アルプス国際芸術祭": {
    "name": "北阿爾卑斯國際藝術祭",
    "tagline": "以藝術旅行北阿爾卑斯的城市與風景。",
    "desc": "在長野縣大町舉辦的國際藝術祭，旨在重新發現地區魅力並塑造具有獨特個性的城市。曾於2017、2021和2024年舉辦。"
  },
  "美濃和紙あかりアート展": {
    "name": "美濃和紙燈光藝術展",
    "tagline": "看美濃古街被和紙燈光柔和照亮。",
    "desc": "以約300件美濃和紙燈光作品點亮卯建歷史街區的長期展覽。作品從日本全國徵集，並透過展覽與評審形成參與型競賽。"
  },
  "アーツカウンシルしずおか": {
    "name": "靜岡藝術委員會（Arts Council Shizuoka）",
    "tagline": "發現靜岡各地文化活動的入口。",
    "desc": "面向靜岡縣全域的藝術文化中間支援機構，透過資助、諮詢和傳播支持藝術家與NPO，並在行政與民間之間發揮橋梁作用。"
  },
  "国際芸術祭「あいち」": {
    "name": "愛知三年展",
    "tagline": "在愛知各地探索來自世界的當代藝術。",
    "desc": "愛知縣每三年舉辦的大型國際當代藝術祭，以愛知藝術文化中心及縣內城市空間為舞台，融合當代藝術、表演藝術與學習計畫。"
  },
  "亀山トリエンナーレ": {
    "name": "龜山三年展",
  ...
  "神戸・新開地（アートひろば等）": {
    ...
    "desc": "以藝術推動神戶新開地再生的長期實踐。閒置建築與店鋪被改造為藝術空間、排練室和小劇場，培養地方文化工作者並形成新的社區據點。"
  },
  "はならぁと": {
    "name": "HANARART 奈良町屋藝術祭",
    "tagline": "在奈良的老街、空屋與村落中發現藝術。",
    "desc": "利用奈良縣各地村落、町屋、閒置建築、寺院與神社舉辦的分散型藝術祭。橿原、宇陀、吉野等區域輪流展開計畫，帶領訪客進入平時較少到訪的地方。"
  },
  "JAPAN WALLS（和歌山）": {
    "name": "JAPAN WALLS 白濱壁畫計畫",
    "tagline": "在和歌山街頭遇見巨型壁畫。",
    "desc": "邀請日本及海外街頭藝術家在建築外牆創作大型壁畫的計畫。強烈的視覺效果改變城市景觀，也透過社群媒體與口碑吸引新的訪客。"
  },
  "鳥取県立美術館の取り組み": {
    "name": "鳥取縣立美術館",
  ...
  "広島国際建築祭": {
    "name": "廣島國際建築節",
    "tagline": "透過建築與城市故事行走尾道和福山。",
    "desc": "2025年從廣島啓動、專注建築的國際節慶。以福山和尾道為中心，透過導覽、展覽和研討會，從建築角度重新思考城市記憶、重建與再生。"
  },
  "YCAM（山口情報芸術センター）": {
    "name": "YCAM 山口資訊藝術中心",
    "tagline": "在山口遇見媒體藝術的實驗。",
    "desc": "由山口市設立的公共媒體藝術中心。透過藝術、技術與研究一體化的研發，以及藝術家和工程師的緊密協作，製作展覽、演出、工作坊與國際合作計畫。"
  },
  "神山AIR": {
    "name": "神山藝術家駐村（KAIR）",
  ...
  "瀬戸内国際芸術祭": {
    ...
    "desc": "每三年在瀨戶內海島嶼與港口舉辦的大型國際藝術祭。直島、豐島、女木島、小豆島等12座島與2個港口分布著常設和臨時作品。主展於2025年舉辦，下一屆為2028年，2026年繼續ART SETOUCHI計畫。"
  },
  "道後オンセアート": {
  ...
  "高知県芸術祭/KOCHI ART PROJECTS": {
    "name": "高知縣藝術祭 / KOCHI ART PROJECTS",
    "tagline": "透過多種表達方式探索高知的城市與社區。",
    "desc": "以高知縣秋季藝術祭為基礎，同時開展支持地方藝術計畫的KOCHI ART PROJECTS。戲劇、音樂、美術、傳統文化與地域實踐在縣內各地展開。"
  },
  "Fukuoka Art Next": {
    "name": "福岡藝術Next（Fukuoka Art Next）",
    "tagline": "在福岡市內各處輕鬆遇見當代藝術。",
    "desc": "福岡市自2022年度啓動的綜合文化政策，透過行政、大學與民間合作擴大市民接觸藝術的機會，並借助Artist Cafe Fukuoka、公共壁畫和藝博會等計畫支持藝術家成長與交流。"
  },
  "Creative Residency in Arita": {
    "name": "有田創意駐村計畫（Creative Residency in Arita）",
    "tagline": "在日本陶瓷之鄉有田，遇見國際藝術家的創作。",
    "desc": "在日本瓷器發源地有田開展的三個月駐村計畫，國內外藝術家和設計師與當地窯元、工匠合作。計畫自2016年啓動，透過國際交流探索有田燒的新可能。",
    "dateText": "2026年6月至8月（藝術家駐村）。"
  },
  "南島原市アートビレッジ・シラキノ": {
    "name": "南島原市Art Village Shirakino",
    "tagline": "在南島原的一所舊學校里探訪藝術家駐村。",
    "desc": "把長崎縣南島原市廢棄學校改造而成的復合藝術設施，支持年輕藝術家駐村創作，並透過工作坊和居民交流推動地方文化發展。"
  },
  "くまもとアートポリス": {
    "name": "熊本Artpolis",
  ...
  "BEPPU PROJECT": {
    ...
    "desc": "以別府為基地的藝術機構和計畫平台。從利用溫泉城市空置空間的國際藝術祭起步，逐漸擴展到駐留、人才培養、空間營運以及連接飲食與文化的計畫，並在公共與民間之間發揮中介作用。"
  },
  "新富芸術祭": {
    "name": "新富藝術祭",
    "tagline": "在宮崎新富的日常生活中感受藝術。",
    "desc": "在宮崎縣新富町的農業景觀、日常社區和歷史祭祀空間中舉辦的小型藝術祭。國內外藝術家與居民合作，重視低負擔、可持續的營運方式。"
  },
  "霧島アートの森活用まちづくり": {
    "name": "霧島戶外美術館地域營造",
  ...
  "やんばるアートフェスティバル": {
    "name": "山原藝術祭（YAMBARU ART FESTIVAL）",
    "tagline": "透過藝術與工藝探索山原的森林與村落。",
    "desc": "在沖繩北部山原地區舉辦的藝術祭，以世界自然遺產周邊的亞熱帶森林、村落和海岸為舞台，融合當代藝術、傳統表演和工藝，並以人與自然共生為核心主題。"
  },
  "恵比寿映像祭2026": {
    "name": "惠比壽映像祭2026",
    "tagline": "在惠比壽感受影像與攝影的當下。",
    "desc": "由東京都寫真美術館主辦的國際影像藝術祭，透過攝影、電影、聲音、表演等形式持續追問“影像是甚麼”。2026年主題為“Polyphonic Voices Bathed in Sunlight”。",
  ...
  "すみだ五彩の芸術祭": {
    "name": "墨田五彩藝術祭",
    "tagline": "漫步墨田，透過藝術遇見地方記憶。",
    "desc": "由墨田區直接主辦的多月藝術祭，是東京23區中首次出現這種規模的區級藝術祭。以“墨分五彩”為靈感，在老宅、寺院、商店街等日常空間重新觀看地方歷史、產業與記憶。"
  },
  "TOKYO ATLAS（国際文化芸術祭）": {
    "name": "TOKYO ATLAS 國際文化藝術祭",
    "tagline": "在東京濱水地區探索來自世界的當代藝術。",
    "desc": "2026年啓動的新東京文化藝術祭中的國際藝術展，以台場、青海、天王洲等濱水區域為舞台，同時呈現國際知名藝術家與東京都支持的年輕藝術家。"
  },
  "前橋国際芸術祭2026「めぶく。」": {
    "name": "前橋國際藝術祭2026「萌芽。」",
    "tagline": "沿著建築與藝術漫步前橋中心城區。",
    "desc": "以前橋市中心為舞台的首屆國際藝術祭。以2016年城市願景“萌芽。”十週年為契機，將藝術與城市更新連接起來，並讓觀眾步行穿梭於商店街、閒置建築和公共空間。"
  },
  "下呂 Art Discovery 2026": {
    "name": "下呂藝術探索 2026（Gero Art Discovery 2026）",
    "tagline": "帶著藝術旅行下呂溫泉、森林與舊校舍。",
    "desc": "在日本三大名泉之一的岐阜下呂舉辦的新藝術祭。森林、歷史街區和舊木造學校中分布場域特定作品，探討人與自然的關係。北川富朗任總導演，共有來自14個國家和地區的59組參加。"
  },
  "富士山芸術祭2026": {
    "name": "富士山藝術祭 2026（Fuji Art Festival 2026）",
    "tagline": "眺望富士山，探索山梨的文化與藝術。",
    "desc": "以世界遺產富士山為中心，連接山梨的歷史建築、寺院、美術館、酒藏與名人相關場所的廣域藝術祭。每四年舉辦一次，透過傳統工藝與當代藝術重新發現地方價值。"
  },
  "三島満願芸術祭2026": {
    "name": "三島滿願藝術祭2026",
    "tagline": "在三島街頭遇見當代藝術。",
    "desc": "以靜岡縣三島為基地的當代藝術祭。2023年11月首次舉辦，2026年迎來第三屆，持續發展把城市空間、社區與當代藝術連接起來的地方模式。"
  },
  "アラフドアートアゲイン": {
  ...
  "神戸六甲ミーツ・アート2026 beyond": {
    ...
    "desc": "自2010年起每年秋天在神戶六甲山舉辦的當代藝術祭。作品散布於豐富的山地自然中，兼具從神戶市中心出發的便利性與戶外藝術體驗。"
  },
  "武雄のあかりめぐり": {
    "name": "武雄燈光巡遊",
  ...
  "飛生芸術祭": {
    "name": "飛生藝術祭（TOBIU ART FESTIVAL）",
    "tagline": "走進北海道森林與舊校舍中的童話般節慶。",
    "desc": "由1986年圍繞北海道白老舊飛生小學成立的TOBIU Art Community舉辦的年度藝術祭。木造校舍與森林變成展覽和交流空間，開幕活動TOBIU CAMP也同期舉行。",
    "dateNote": "TOBIU CAMP於9月12日舉行。"
  },
  "福島ビエンナーレ2026": {
    "name": "福島雙年展2026",
    "tagline": "在福島雙葉面對記憶、地方與當代藝術。",
    "desc": "自2004年起每兩年舉辦的當代藝術計畫。2026年適逢東日本大地震15週年，以“Cinematic ∞ Art”為主題，在雙葉郡8個自治體展開，把福島大學與地方社區透過藝術和文化記憶連接起來。"
  },
  "AWANO 夢咲くART FESTIVAL 2026": {
    "name": "AWANO 夢開ART FESTIVAL 2026",
    "tagline": "在鹿沼里山中享受花、藝術與美食。",
    "desc": "自2016年起在栃木縣鹿沼市粟野地區舉辦的藝術祭。以現、舊粟野中學為中心，結合展覽、舞台、集市，以及蕎麥花和彼岸花等季節性里山風景。"
  },
  "房総国際芸術祭 アート×ミックス2027": {
    "name": "房總國際藝術祭 Boso Triennale 2027",
    "tagline": "為了藝術、音樂與美食橫穿房總半島。",
    "desc": "跨越千葉縣市原、木更津與大多喜的新國際藝術祭。由北川富朗與小林武史領銜，把房總半島想象為一座共享“藝術工廠”，鼓勵乘火車、駕車或騎行探索。"
  },
  "横浜トリエンナーレ": {
    "name": "橫濱三年展",
  ...
  "逗子アートフェスティバル": {
    ...
    "desc": "自2013年起每年在神奈川縣逗子舉辦的藝術活動，以“透過藝術營造社區”為核心，由居民和藝術家共同在城市與海岸各處開展計畫。"
  },
  "ART/X/TOYAMA（アートエクストヤマ）": {
  ...
  "いしかわ舞台芸術祭2026": {
    ...
    "desc": "在石川縣舉辦、邀請日本及海外藝術家的表演藝術祭，呈現戲劇、舞蹈、音樂與跨領域作品，為觀眾提供新的舞台體驗和文化交流機會。",
    "dateText": "2026年9月至12月22日。"
  },
  "熊川宿若狭芸術祭": {
    "name": "熊川宿若狹藝術祭",
  ...
  "大野芸術祭（OHNO ART BREW）": {
    "name": "大野藝術祭（OHNO ART BREW）",
    "tagline": "帶著藝術漫步常滑大野的海邊小鎮。",
    "desc": "自2024年起在愛知縣常滑市大野町舉辦的藝術祭。作品進入海岸、車站廣場、咖啡館等日常場所，以免費、貼近社區的形式逐漸扎根。"
  },
  "長浜国際芸術祭": {
    "name": "長濱國際藝術祭2026",
  ...
  "KYOTO EXPERIMENT 京都国際舞台芸術祭2026": {
    "name": "京都實驗國際舞台藝術祭 2026（KYOTO EXPERIMENT）",
    "tagline": "在秋日京都穿梭於實驗性表演之間。",
    "desc": "自2010年起在京都各地舉辦的表演藝術祭，介紹跨越戲劇、舞蹈、音樂與視覺藝術的國內外先鋒作品，由Kansai Studies、Shows、SKF三條計畫線構成。2026年10月3日至25日舉辦。"
  },
  "生きた建築ミュージアムフェスティバル大阪（イケフェス大阪）": {
  ...
  "紀南アートウィーク": {
    ...
    "tagline": "透過藝術探索紀南的海、山與日常文化。",
    "desc": "以和歌山縣紀南地區、包括田邊為基地持續開展的藝術計畫。透過展覽與講座，從當代藝術視角觀察柑橘種植、漁業、地方歷史與信仰等當地生活方式。"
  },
  "森の芸術祭 晴れの国・岡山2027": {
    "name": "岡山森林藝術祭2027",
    "tagline": "旅行岡山北部，遇見森林與藝術。",
    "desc": "連接津山、高梁、新見、真庭、美作等岡山北部12個市町村的國際藝術祭。2024屆部分作品已成為常設作品，下一屆計畫於2027年秋季舉辦。",
    "dateText": "計畫於2027年秋季舉辦。"
  },
  "瀬戸内産業芸術祭": {
    "name": "瀨戶內產業藝術祭",
    "tagline": "透過藝術重新觀看瀨戶內的產業景觀。",
    "desc": "以鹽業、造船、鋼鐵等支撐日本發展的瀨戶內產業為對象的分散型美術館構想。藝術家和創作者與企業工廠合作，從新的角度重新理解產業文化。"
  },
  "MAFIN（Miyajima Art Festival in the Narrative）": {
    "name": "MAFIN（宮島敘事藝術祭）",
    "tagline": "在宮島寺院中觀看歷史與當代藝術相遇。",
    "desc": "每年在廣島宮島彌山的大聖院舉辦的當代藝術展。計畫透過藝術思考和平與島嶼文化意義，並讓受宮島自然啓發的作品與歷史寺院空間展開對話。"
  },
  "ART FAIR ASIA FUKUOKA（AFAF）": {
  ...
  "SAGA ARTIST FAIR 2027": {
    ...
    "desc": "以佐賀市為基地、聚焦發現與介紹新銳藝術家的公開徵集型藝博會。每屆透過公開報名選出參展藝術家，2027年計畫於2月中旬舉辦，報名自2026年8月中旬開始。",
    "dateText": "計畫於2027年2月中旬舉辦。"
  },
  "種子島宇宙芸術祭": {
    "name": "種子島宇宙藝術祭",
    "tagline": "在種子島同時體驗宇宙與藝術。",
    "desc": "以鹿兒島縣南種子、種子島宇宙中心周邊為舞台的獨特藝術祭。受天文學家Carl Sagan思想啓發，以“宇宙藝術”為新領域，並舉辦夏季營地和冬季燈光節。"
  },
  "Waza Waza — Iga Art Book Fair 2026": {
